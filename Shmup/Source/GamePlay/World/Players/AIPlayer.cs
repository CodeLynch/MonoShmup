...
namespace Shmup
{
    ...
    {
        Ship enemy;
        public AIPlayer(Ship enemy, int id) : base(id)
        {
            //spawns.Add(new PopcornSpawn(new Vector2(Globals.screenBound.Left + 20, Globals.screenBound.Top + 10), new Vector2(32, 32), id));
